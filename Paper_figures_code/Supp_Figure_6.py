...
if __name__ == '__main__':
    ...
    path_data = '../../glm-hmm_package/data/ibl/Della_cluster_data/separate_mouse_data/'  # ' /Users/zashwood/Documents/glm-hmm/data/ibl/Della_cluster_data/separate_mouse_data/'
    figure_dir = '../../glm-hmm_package/results/figures_for_paper/Supp_figures/figure_6/'
    ...
    plt.subplots_adjust(left=0.12, bottom=0.1, right=0.95, top=0.95, wspace=0.25, hspace=0.9)
    ...
    for k in range(K):
        ...
        for animal in mice_names:
            ...
            # Get the file name corresponding to the best initialization for a given K value
            ...
            print('Params_model[1][1]=', Params_model[1][1])
            print('animal=', animal)
            ...
            if animal == "churchlandlab/CSHL_014/_ibl_subjectTrials.table.61f6982a-40fb-44a6-8f2f-170235951e26.pqt":
                ...
                plt.plot(range(M),
                         ...
                         markersize=3,
                         zorder=0)
                # plt.title('State ' + str(k+1), color=cols[k], y=1.0, pad=-14)
        ...
        if k == 0:
            ...
            plt.xticks([0, 1, 2, 3], figure_covariates_names,
                       fontsize=7,
                       rotation=60)
            plt.ylabel('Obs. GLM weight', fontsize=9)
        else:
    ...
    for k in range(K):
        ...
        if k == 0:
            ...
            plt.xticks([0, 1, 2, 3, 4, 5], figure_covariates_names_trans,
                       fontsize=7,
                       rotation=60)
            plt.ylabel('Trans. GLM weight', fontsize=9)
        else:
