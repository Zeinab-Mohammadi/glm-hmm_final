...
if __name__ == '__main__':
    ...
    figure_dir = '../../glm-hmm_package/results/figures_for_paper/Supp_figures/figure_3/'
    ...
    plt.subplots_adjust(left=0.15, right=0.95, bottom=0.2, wspace=0.25, hspace=0.5)
    ...
    for k in range(K):
        ...
        plt.hist(dwell_all[k],
                 ...
                 histtype='bar',
                 rwidth=0.8)
        plt.xticks([0, 20, 40, 60], ["", "", "", ""], fontsize=9)
        a = [0,  100, 200, 300, 400]
        b = a
        # b = [0, 30, 60, 90, 120]
        ...
        if k == 0:
            plt.xticks([0, 20, 40, 60], ["0", "20", "40", "60"], fontsize=9)
            ...
            plt.legend(fontsize=8,
                       ...
                       markerscale=1)
        if k == 0:
            plt.yticks(a, [0, 100, 200, 300, 400], fontsize=9)
        else:
            plt.yticks(a, ["", "", "", "", ""], fontsize=9)
