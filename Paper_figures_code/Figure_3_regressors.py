...
if __name__ == '__main__':
    ...
    plt.subplot(4, 1, 1)
    plt.scatter(range(0, Len), all_data_y[0:Len, 0], s=60, label="choice", facecolors='none', edgecolors='gray')
    plt.scatter(range(0, Len), stimulus_side[0: Len],  s=20, label="stimulus", facecolors='orange')
    ...
    plt.gca().spines['right'].set_visible(False)
    plt.gca().spines['top'].set_visible(False)
    # fig.savefig(figure_dir + 'trans_filtered_reward' + '.pdf')
